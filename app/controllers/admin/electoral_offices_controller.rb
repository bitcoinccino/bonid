...
# CRUD for CEP's electoral offices (BED + BEK). Admin-only — each row is a
# physical CEP building that citizens can walk into for help. The locator
# page in the citizen portal reads from the same table.
#
