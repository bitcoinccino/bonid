...
register("certificate-toggle", () =>
  ...
  register("otp-input", () => import("./otp_input_controller"))
  register("auto-modal", () => import("./auto_modal_controller"))
  ...
  register("image-quality", () => import("./image_quality_controller"))
  register("proof-picker", () => import("./proof_picker_controller"))
  register("wizard-persistence", () => import("./wizard_persistence_controller"))
