...
ActiveRecord::Schema[8.0].define(version: 2026_04_29_020000) do
  ...
  create_table "election_key_shards", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "envelope_version", default: "v1"
    t.text "recipient_public_key_b64"
  ...
  create_table "electoral_offices", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "polling_centers", force: :cascade do |t|
    t.bigint "bonvote_election_id", null: false
    t.string "name", null: false
    ...
    t.string "postal_code"
    t.string "country_code", default: "HT", null: false
    t.float "latitude"
    t.float "longitude"
    t.bigint "department_id"
    t.bigint "arrondissement_id"
    ...
    t.index ["bonvote_election_id"], name: "index_polling_centers_on_bonvote_election_id"
  ...
  create_table "polling_stations", force: :cascade do |t|
    t.bigint "polling_center_id", null: false
    t.integer "bv_number", null: false
    t.integer "capacity", default: 450, null: false
  ...
  create_table "voter_eligibility_records", force: :cascade do |t|
    ...
    t.bigint "polling_station_id"
    t.datetime "assigned_at"
    t.bigint "transferred_from_station_id"
    t.bigint "registered_by_partner_id"
    t.datetime "registered_at"
    t.string "preferred_channel", default: "in_person", null: false
    t.string "voted_channel"
    t.bigint "communal_section_id"
    t.string "diplomatic_mission_id"
    t.string "source", default: "digital", null: false
    ...
    t.index ["bonvote_election_id", "polling_station_id"], name: "idx_voters_election_station"
    t.index ["bonvote_election_id"], name: "index_voter_eligibility_records_on_bonvote_election_id"
    t.index ["cin_number"], name: "index_voter_eligibility_records_on_cin_number"
    t.index ["communal_section_id"], name: "index_voter_eligibility_records_on_communal_section_id"
    t.index ["diplomatic_mission_id"], name: "index_voter_eligibility_records_on_diplomatic_mission_id"
    t.index ["has_voted"], name: "index_voter_eligibility_records_on_has_voted"
    t.index ["polling_station_id"], name: "index_voter_eligibility_records_on_polling_station_id"
    t.index ["registered_by_electoral_office_id"], name: "idx_on_registered_by_electoral_office_id_c6359c3bcb"
    t.index ["registered_by_partner_id"], name: "index_voter_eligibility_records_on_registered_by_partner_id"
    t.index ["status"], name: "index_voter_eligibility_records_on_status"
    t.index ["transferred_from_station_id"], name: "index_voter_eligibility_records_on_transferred_from_station_id"
    t.index ["user_id"], name: "index_voter_eligibility_records_on_user_id"
  end

  create_table "voter_oath_acknowledgements", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "bonvote_election_id", null: false
    t.bigint "identity_submission_id"
    ...
    t.string "oath_version", default: "v1", null: false
    t.string "digest", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["accepted_at"], name: "index_voter_oath_acknowledgements_on_accepted_at"
    t.index ["bonvote_election_id"], name: "index_voter_oath_acknowledgements_on_bonvote_election_id"
    t.index ["digest"], name: "index_voter_oath_acknowledgements_on_digest", unique: true
    t.index ["identity_submission_id"], name: "index_voter_oath_acknowledgements_on_identity_submission_id"
    t.index ["user_id", "bonvote_election_id", "oath_version"], name: "idx_voter_oath_uniq_per_election", unique: true
    t.index ["user_id"], name: "index_voter_oath_acknowledgements_on_user_id"
  end
  ...
  add_foreign_key "polling_centers", "arrondissements"
  add_foreign_key "polling_centers", "bonvote_elections", on_delete: :cascade
  ...
  add_foreign_key "voter_eligibility_records", "communal_sections"
  add_foreign_key "voter_eligibility_records", "electoral_offices", column: "registered_by_electoral_office_id"
  add_foreign_key "voter_eligibility_records", "partners", column: "registered_by_partner_id"
  add_foreign_key "voter_eligibility_records", "polling_stations"
  add_foreign_key "voter_eligibility_records", "polling_stations", column: "transferred_from_station_id"
  add_foreign_key "voter_eligibility_records", "users"
  add_foreign_key "voter_oath_acknowledgements", "bonvote_elections"
  add_foreign_key "voter_oath_acknowledgements", "identity_submissions"
  add_foreign_key "voter_oath_acknowledgements", "users"
